      ...
      <Card header="Article Content">
        <Form onSubmit={onSaveChanges}>
          ...
          >
            ...
            <Textarea
              value={articleDTO.description}
              onChange={description => onChanges({description})}
            />
          </div>
          <label>Content</label>
          <WYSIWYGEditor
            defaultContent={articleDTO.content}
            onChanges={content => onChanges({content: content as any})}
          />
          <div
            style={{
              display: 'flex',
