    ...
    <Card
      header={
        <>
          ...
          Online Users {page > 0 && <small>Page {page + 1}</small>}
        </>
      }
    >
      <Grid>
      ...
      <GridLarge>
        {canGoDown ? (
          <ButtonClear onClick={goBackOnePage}>
            <i
              className={loading ? 'fa fa-spinner fa-spin' : 'fa fa-arrow-left'}
            />
          </ButtonClear>
        ) : (
          <div />
        ...
        {canGoUp && (
          <ButtonClear onClick={goUpOnePage}>
            <i
              className={
                loading ? 'fa fa-spinner fa-spin' : 'fa fa-arrow-right'
              }
            />
          </ButtonClear>
        )}
